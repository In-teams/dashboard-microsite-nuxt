<template>
  <div>
    ...
    <div class="px-2 mt-16">
      ...
      />
      <Subtitle
        :subtitle="'Formulir Redemption difoto / diunggah jika sudah datanya'"
        ...
        <div class="border-2 border-gray-400 rounded-xl py-10 text-center">
          ...
          >
            ...
            <span class="mt-2 text-purple-900 text-base leading-normal text-sm">
              Foto atau unggah formulir Redemption</span
            >
            <input
              type="file"
      ...
      <Button
        @tesClick="submitFile"
        :titleButton="'Kirim Formulir Redemption'"
